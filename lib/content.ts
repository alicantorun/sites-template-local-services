// The content contract: every business fact in ONE typed module (the website-builder template
// contract). "Change my phone number" is a one-line edit here, and the whole site plus its SEO
// metadata read from it. The agent edits this for content changes and the components for
...
export const site = {
    business: {
        ...
        // Rendered as a tel: link, so it must stay dialable — digits and + only.
        phoneHref: "+442079460321",
        address: "Unit 4, Bevan Yard, London E8",
        emergency: "24h emergency call-out",
    },
    nav: [
    ...
    hero: {
        ...
        primaryCta: { label: "Call now", href: "tel:+442079460321" },
    ...
    contact: {
        ...
        subtitle:
            "Tell us the job and your postcode. We reply the same working day, usually within a couple of hours.",
    },
} as const;
